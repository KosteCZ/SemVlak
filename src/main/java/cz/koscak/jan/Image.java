...
public enum Image {
    ...
    RAILROAD_CROSSING_NO_LIGHT("railroad-crossing-no-light"),
    RAILROAD_CROSSING_WHITE("railroad-crossing-white"),
    RAILROAD_CROSSING_RED_LEFT("railroad-crossing-red-left"),
    RAILROAD_CROSSING_RED_RIGHT("railroad-crossing-red-right"),
